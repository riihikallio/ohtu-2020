...
public class Stepdefs {
    ...
    @When("incorrect username {string} and valid password {string} are given")
    public void incorrectUsernameAndValidPasswordAreGiven(String username, String password) {
        logInWith(username, password);
    }    
