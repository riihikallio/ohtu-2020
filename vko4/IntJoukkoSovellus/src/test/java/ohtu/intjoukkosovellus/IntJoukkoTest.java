...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.sisaltyy(10));
        assertFalse(joukko.sisaltyy(5));
        assertFalse(joukko.sisaltyy(0));
        assertTrue(joukko.sisaltyy(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.sisaltyy(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.sisaltyy(11));
        joukko.poista(11);
        assertFalse(joukko.sisaltyy(11));
